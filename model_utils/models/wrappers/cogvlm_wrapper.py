...
class CogVLMModelWrapper:
    """Wrapper for THUDM CogVLM vision-language models.
    
    CogVLM is a state-of-the-art VLM from Tsinghua University.
    This wrapper extracts text features for similarity matching.
    """
    
    def __init__(self, model_name="THUDM/cogvlm-chat-hf", device=None):
    ...
    def _load_model(self):
        """Load CogVLM model and tokenizer from Hugging Face."""
    ...
    def encode_text(self, texts):
        ...
        # Get embeddings
        with torch.no_grad():
            # CogVLM outputs hidden states - we use the last layer
    ...
    def embedding_dim(self):
        ...
        # CogVLM typically uses 4096 dimensions

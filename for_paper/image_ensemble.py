...
def main() -> None:
    ...
    # Compute features (one cosine per font)
    ...
    # Build feature matrices (6 cosine similarities)
    ...
    feat_names = ["cosine_deja", "cosine_unifont", "cosine_libre", "cosine_exo2", "cosine_doulos", "cosine_cousine"]
...
"""
python3 for_paper/image_ensemble.py \

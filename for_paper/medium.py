...
def main() -> None:
    ...
    ap.add_argument("--model-output-path", default="saved_models/medium_model.joblib")
    ...
    joblib.dump(
        {
            ...
            "gentium_fraud_prefix": args.gentium_fraud_prefix,
            "gentium_real_prefix": args.gentium_real_prefix,
        },
...
python3 for_paper/medium.py \
  ...
  --model adaboost \
  --model-output-path saved_models/medium_model.joblib
"""
...
python3 seton_notebooks/create_golden_embeddings.py \
...
python3 seton_notebooks/create_golden_with_VATE_embeddings_precomputed.py \
...
python3 seton_notebooks/build_t2i_positive_only_dataset.py \

...
def read_parquet(font: str) -> pd.DataFrame:
    ...
    """
    filename = f"sub_opt/cosine sim/{font}_validate_pairs_ref_10k.parquet"
...
def load_baseline_parquet() -> pd.DataFrame:
    ...
    Returns:
        DataFrame with columns: ['fraudulent_name', 'real_name', 'label', 'cosine_sim']
    """
    baseline_path = "sub_opt/cosine sim/dejavusans_validate_pairs_ref_10k.parquet"
...
def main() -> None:
    ...
    font_thresholds = {
        "tahoma": 0.8396778702735901,
        "robotocondensed":  0.837533712387085,
        "centurygothic": 0.8161032199859619,
        "helvetica": 0.8311429023742676,
        "silom": 0.8106552362442017,
        "calibri": 0.8455080389976501,
        "caveat": 0.8533912897109985,
        "pacifico": 0.8160889148712158,
        "nanumbrush": 0.834489107131958,
        "sourcecodepro": 0.8325141668319702,
        "dejavusans": 0.8368422985076904,
    }
